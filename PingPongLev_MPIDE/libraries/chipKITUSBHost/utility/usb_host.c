...
BOOL _USB_FindClassDriver( BYTE bClass, BYTE bSubClass, BYTE bProtocol, BYTE *pbClientDrv )
{
    ...
    while (i < NUM_TPL_ENTRIES)
    {
            ...
            (((usbTPL[i].flags.bfIgnoreProtocol == 0) ? (usbTPL[i].device.bProtocol == bProtocol) : TRUE))  )
        {
            ...
            #ifdef DEBUG_MODE
                UART2PutString( "HOST: Client driver found.\r\n" );
            #endif
...
#ifdef DEBUG_MODE
    UART2PutString( "HOST: Client driver NOT found.\r\n" );
#endif
...
BOOL _USB_FindDeviceLevelClientDriver( void )
{
    ...
    while (i < NUM_TPL_ENTRIES)
    {
        if (usbTPL[i].flags.bfIsClassDriver)
        {
            ...
            {
            #ifdef DEBUG_MODE
                UART2PutString( "HOST: Device validated by class\r\n" );
            #endif
...
#ifdef DEBUG_MODE
    UART2PutString( "HOST: Device not yet validated\r\n" );
#endif
...
//    }
    ...
    #ifdef DEBUG_MODE
        UART2PutString( "HOST: No supported interfaces.\r\n" );
    #endif
    ...
    else
    {
        ...
        // Success!
    #ifdef DEBUG_MODE
        UART2PutString( "HOST: Parse Descriptor success\r\n" );
    #endif
